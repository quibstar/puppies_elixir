defmodule Puppies.BusinessesTest do
  ...
  describe "businesses" do
    ...
    @invalid_attrs %{description: nil, federal_license: nil, name: nil, phone: nil, state_license: nil, website: nil}
    ...
    test "create_business/1 with valid data creates a business" do
      valid_attrs = %{description: "some description", federal_license: true, name: "some name", phone: "some phone", state_license: true, website: "some website"}
    ...
    test "update_business/2 with valid data updates the business" do
      business = business_fixture()
      update_attrs = %{description: "some updated description", federal_license: false, name: "some updated name", phone: "some updated phone", state_license: false, website: "some updated website"}
