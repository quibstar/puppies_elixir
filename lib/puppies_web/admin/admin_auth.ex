defmodule PuppiesWeb.AdminAuth do
  import Plug.Conn
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_puppies_web_admin_remember_me"
  ...
  def log_out_admin(conn) do
    ...
    admin_token && Admins.delete_session_token(admin_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      PuppiesWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(_conn), do: "/admin/dashboard"
end
