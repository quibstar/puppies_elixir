            ...
            <div class="bg-white mt-4 border rounded">
              <div class="px-4 py-5 sm:p-6">
                ...
                <p class="text-sm text-gray-700">
                  You must be at the reputation level of <PuppiesWeb.Badges.reputation_level reputation_level={@business_or_listing.user.reputation_level} /> to communicate with <%= @business_or_listing.name %> about <%= @business_or_listing.name %>.
                </p>
                <div class="mt-2">
