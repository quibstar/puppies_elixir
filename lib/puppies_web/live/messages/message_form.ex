        ...
        <div class="p-4">
          <%= if  @current_thread.receiver.reputation_level > @current_thread.sender.reputation_level do %>
            <div class="text-gray-500">
              <p>To communicate with <%= @current_thread.receiver.first_name %> <%= @current_thread.receiver.last_name %> about <%= @listing.name %> you must be at the reputation level of <PuppiesWeb.ReputationLevel.badge reputation_level={@current_thread.receiver.reputation_level} /></p>
              <p>You are currently at level <PuppiesWeb.ReputationLevel.badge reputation_level={@current_thread.sender.reputation_level} /></p>
              <div class="mt-2">
