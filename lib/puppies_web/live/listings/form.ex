            ...
            <.form let={f} for={@changeset} id="listing-form" phx-submit="save_listing" phx_change="validate" phx-target={@myself}>
              ...
              <div class=" mt-4">
                <div class="flex flex-col">
                  <%= submit "Submit", phx_disable_with: "Saving...",  disabled: !@changeset.valid? || current_photos_and_uploaded_photos(@current_photos, @uploads),  class: "inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-primary-500 rounded shadow hover:shadow-lg hover:bg-primary-600 focus:outline-none disabled:opacity-50" %>
                </div>
              </div>
            </.form>
          </div>
