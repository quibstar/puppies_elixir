defmodule Puppies.DistanceOfTimeHelpers do
  @moduledoc false
  ...
  defp translate_duration(msg, opts \\ []) do
    if count = opts[:count] do
      Gettext.dngettext(PuppiesWeb.Gettext, "durations", msg, msg, count, opts)
    else
      Gettext.dgettext(PuppiesWeb.Gettext, "durations", msg, opts)
    end
  end
end
